...
class WebGenerator:
    ...
    @staticmethod
    def __gen_items_content(page, dep, items, cur_datetimestamp):
    ...
    @staticmethod
    def __gen_common_columns(file, repo, commit, item, type_class_id, cur_datetimestamp):
